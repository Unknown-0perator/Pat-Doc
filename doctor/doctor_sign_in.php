...
<body>
  <h1 class="header">Doctor Login | <span>Pat-Doc</span></h1>
  <main class="cont1">
    <form method="POST" class="form-wrapper">
      <fieldset class="fs-wrapper">
        ...
        <label class="lbl2"><a href="doctor_forgetPassword.php" class="href1">Forgot your password?</a></label>
      </fieldset>
      <div class="signin">
      ...
      <hr id="wrapper">
      <div class="target1">
        <p class="signup">Don't Have An Account Yet?<a href="./doctor_sign_up.php" class="href2">&nbsp; Sign
            up</a>&nbsp; |
